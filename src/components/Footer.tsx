      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div className="md:col-span-3">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
              <div>
                <h3 className="font-semibold text-foreground mb-2">Popular Tools</h3>
                <ul className="space-y-1 text-muted-foreground">
                  <li><Link href="/password-generator" className="hover:text-foreground transition-colors">Password Generator</Link></li>
                  ...
                  <li><Link href="/hash-generator" className="hover:text-foreground transition-colors">Hash Generator</Link></li>
                </ul>
              </div>
        ...
        <div className="border-t border-border pt-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
            <p>
              © {currentYear} ToolsHub. Professional free online tools for security, calculations, and design.
            </p>
            <div className="flex items-center space-x-4 mt-2 md:mt-0">
              <a href="https://www.the-tools-hub.com" className="hover:text-foreground transition-colors">
                the-tools-hub.com
              </a>
            </div>
          </div>
