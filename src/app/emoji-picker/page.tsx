      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Browse, search, and copy emojis with keyboard navigation and recent history tracking",
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Browse, search, and copy emojis with keyboard navigation and recent
            history tracking. Comprehensive emoji database organized by
            categories with one-click copy functionality and text composition
            features.
          </p>
        </div>
              ...
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {emojisToDisplay.length} emoji
                    {emojisToDisplay.length !== 1 ? "s" : ""}
                  </span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div className="mt-4 pt-4 border-t border-border">
                  <div className="text-sm text-muted-foreground space-y-1">
                    <div>
                      • <strong>Click</strong> an emoji to copy it to clipboard
                    </div>
                    <div>
                      • <strong>Double-click</strong> an emoji to add it to the
                      text area
                    </div>
                    <div>
                      • Use <strong>search</strong> to find emojis by name or
                      keywords
                    </div>
                    <div>
                      • <strong>Recently used</strong> emojis are saved for
                      quick access
                    </div>
                  </div>
                </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Use the search bar to find specific emojis by name or keyword.
                  Browse by categories like smileys, animals, food, activities,
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Click any emoji to copy it instantly to your clipboard. Use
                  the text area to compose messages with multiple emojis before
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Your recently used emojis are remembered and displayed for
                  quick access. The history is stored locally in your browser
                  for privacy.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Access thousands of emojis from the latest Unicode standard,
                  organized in logical categories with full text search
                  capabilities.
                </p>
              </div>
            </CardContent>
        ...
        <Alert className="mb-8">
          ...
          <AlertDescription>
            <strong>Privacy Note:</strong> Recent emoji history is stored
            locally in your browser and never sent to our servers. Your usage
