...
export default function BMICalculator() {
  ...
  const calculateBMI = () => {
    ...
    if (bmi < 18.5) {
      ...
      description = "You may benefit from losing some weight. Consider a balanced diet and exercise.";
    } else {
      category = "Obese";
      color = "text-red-600";
      ...
      <script 
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebApplication",
            "name": "BMI Calculator",
            "description": "Calculate your Body Mass Index (BMI) to determine if you're in a healthy weight range",
      ...
      >
        ...
        <Card className="mb-8">
          ...
          <CardContent className="prose prose-sm max-w-none">
            ...
            <p>
              While BMI is a useful screening tool, it&apos;s not a diagnostic tool. BMI doesn&apos;t measure body fat directly, 
              and it may not be accurate for all individuals, such as athletes with high muscle mass.
            </p>
            <p>
              For a complete health assessment, consult with a healthcare professional who can evaluate your overall health, 
              body composition, and other factors beyond BMI.
            </p>
          </CardContent>
        </Card>
      </motion.div>
