...
export default function CookiePolicyPage() {
  ...
  const webPageSchema = {
    ...
    description: "Comprehensive cookie policy explaining how ToolsHub uses cookies, tracking technologies, and how users can manage their cookie preferences.",
    isPartOf: {
      "@type": "WebSite",
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Learn how we use cookies and tracking technologies to enhance your experience and protect your privacy.
              </p>
            ...
            <Alert className="mb-8 border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950">
              ...
              <AlertDescription className="text-base">
                <strong>Quick Summary:</strong> We use minimal cookies for essential functionality, anonymous analytics,
                and relevant advertising. You can control most cookies through your browser settings.
              </AlertDescription>
            </Alert>
              ...
              <CardContent>
                <nav aria-label="Cookie Policy Navigation">
                  <ol className="list-decimal list-inside space-y-2 text-sm">
                    ...
                    <li><a href="#cookie-details" className="text-primary hover:underline">Detailed Cookie Information</a></li>
                    ...
                    <li><a href="#browser-controls" className="text-primary hover:underline">Browser-Specific Cookie Controls</a></li>
                    <li><a href="#mobile-controls" className="text-primary hover:underline">Mobile Device Controls</a></li>
                    <li><a href="#opt-out-tools" className="text-primary hover:underline">Third-Party Opt-Out Tools</a></li>
                    <li><a href="#cookie-updates" className="text-primary hover:underline">Updates to Cookie Usage</a></li>
                    <li><a href="#contact-us" className="text-primary hover:underline">Contact Information</a></li>
                  </ol>
                </nav>
              </CardContent>
            </Card>
            ...
            <div className="space-y-8">
              ...
              <Card id="what-are-cookies">
                ...
                <CardContent className="space-y-4">
                  ...
                  <h3 className="text-lg font-semibold">1.1 How Cookies Work</h3>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>Storage:</strong> Cookies are stored in your web browser's memory or on your device</li>
                    <li><strong>Information:</strong> They contain small amounts of data, such as preferences or session information</li>
                    <li><strong>Communication:</strong> When you return to a website, cookies help the site recognize you and your preferences</li>
                    <li><strong>Expiration:</strong> Cookies can be temporary (session cookies) or persistent (stored for a set period)</li>
                  </ul>

                  <h3 className="text-lg font-semibold">1.2 Cookie Safety</h3>
                  <p>
                    Cookies cannot run programs, carry viruses, or access your personal files. They are simply text files
                    that help websites function properly and remember your preferences.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card id="why-we-use-cookies">
                ...
                <CardContent className="space-y-4">
                  <p>
                    We use cookies to enhance your experience on ToolsHub and to ensure our services work properly.
                    Our approach prioritizes user privacy while providing essential functionality.
                  </p>

                  <h3 className="text-lg font-semibold">2.1 Primary Purposes</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 border rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Remember your preferences like dark mode, language settings, and tool configurations.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-semibold flex items-center mb-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Understand how users interact with our tools to improve functionality and user experience.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-semibold flex items-center mb-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Anonymously track usage patterns to identify popular tools and optimize performance.
                      </p>
                    </div>
                    <div className="p-4 border rounded-lg">
                      <h4 className="font-semibold flex items-center mb-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Display relevant advertisements to support our free services while respecting your privacy.
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card id="types-of-cookies">
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 gap-6">
                    ...
                    <div className="border rounded-lg p-4">
                      <div className="flex items-center mb-3">
                        <Badge variant="secondary" className="mr-2">Functional</Badge>
                      ...
                      <tbody>
                        {cookieData.map((cookie, index) => (
                          <tr key={index} className="hover:bg-muted/30">
                            <td className="border border-border p-3 font-medium">{cookie.name}</td>
                            <td className="border border-border p-3">
                              <Badge
                                variant={
                                  cookie.type === 'Essential' ? 'destructive' :
                                  cookie.type === 'Analytics' ? 'outline' :
                                  cookie.type === 'Functional' ? 'secondary' : 'default'
                                }
                                className="text-xs"
                              >
                                {cookie.type}
                            ...
                            <td className="border border-border p-3">{cookie.purpose}</td>
                            <td className="border border-border p-3">{cookie.duration}</td>
                            <td className="border border-border p-3 text-xs text-muted-foreground">{cookie.domain}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
              ...
              <Card id="third-party-cookies">
                ...
                <CardContent className="space-y-4">
                  <p>
                    ...
                    These services help us provide better functionality and support our free services.
                  </p>

                  <h3 className="text-lg font-semibold">5.1 Google Analytics</h3>
                  <ul className="list-disc list-inside space-y-1 ml-4">
                    <li><strong>Purpose:</strong> Website analytics and user behavior insights</li>
                    <li><strong>Data Collection:</strong> Anonymous usage statistics</li>
                    <li><strong>Privacy:</strong> IP anonymization enabled</li>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4">
                    <li><strong>Purpose:</strong> Display relevant advertisements</li>
                    <li><strong>Data Collection:</strong> Anonymous ad targeting and performance measurement</li>
                    <li><strong>Privacy:</strong> Compliant with privacy regulations</li>
                    <li><strong>Controls:</strong> <a href="https://adssettings.google.com/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google Ad Settings</a></li>
                  </ul>

                  <h3 className="text-lg font-semibold">5.3 Content Delivery Networks</h3>
                  <p>
                    We may use CDNs to deliver website resources efficiently. These services may set technical cookies
                    for performance optimization and security purposes.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card id="managing-cookies">
                ...
                <CardContent className="space-y-4">
                  ...
                  <h3 className="text-lg font-semibold">6.1 Browser Settings</h3>
                  <p>
                  ...
                  <h3 className="text-lg font-semibold">6.2 Granular Control</h3>
                  <p>
              ...
              <Card id="mobile-controls">
                ...
                <CardContent className="space-y-4">
                  <h3 className="text-lg font-semibold">8.1 iOS (iPhone/iPad)</h3>
                  <ol className="list-decimal list-inside space-y-1 ml-4">
                    <li>Open Settings app</li>
                    <li>Scroll down and tap Safari</li>
                    <li>Under Privacy & Security, manage cookie settings</li>
                    <li>Choose "Block All Cookies" or "Allow from Websites I Visit"</li>
                  </ol>
                  ...
                  <h3 className="text-lg font-semibold">8.3 Mobile Advertising Controls</h3>
                  <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <Card id="opt-out-tools">
                ...
                <CardContent className="space-y-4">
                  <h3 className="text-lg font-semibold">9.1 Industry Opt-Out Pages</h3>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                      <a href="http://www.aboutads.info/choices/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                        Digital Advertising Alliance (DAA)
                      </a> - US advertising opt-out
                    </li>
                    <li>
                      <a href="http://www.youronlinechoices.eu/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                        Your Online Choices
                      </a> - European advertising opt-out
                    </li>
                    <li>
                      ...
                      </a> - Network advertising opt-out
                    </li>
                  </ul>

                  <h3 className="text-lg font-semibold">9.2 Google-Specific Controls</h3>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                      <a href="https://adssettings.google.com/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                        Google Ad Settings
                      </a> - Control ad personalization
                    </li>
                    <li>
                      ...
                      </a> - Browser add-on to disable tracking
                    </li>
                    <li>
                      <a href="https://myaccount.google.com/data-and-privacy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                        Google Privacy Controls
                      </a> - Comprehensive privacy settings
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card id="cookie-updates">
                ...
                <CardContent>
                  <p>
                    We may update our cookie usage from time to time to improve our services or comply with legal requirements.
                    When we make significant changes to our cookie practices, we will:
                  </p>
            ...
            <div className="mt-12 p-6 bg-muted/30 rounded-lg text-center">
              <p className="text-sm text-muted-foreground">
                This Cookie Policy is effective as of {lastUpdated} (Version {version}).
                We are committed to transparency in our cookie usage and will continue to update our practices
                to ensure the best balance of functionality and privacy protection.
              </p>
            </div>
          </motion.div>
        </div>
